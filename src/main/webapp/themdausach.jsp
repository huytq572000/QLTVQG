...
<div id="page" class="d-flex">
    ...
    <div class="flex-grow-1">
        ...
        <!--  phần nhét code -->
        <form id="formThem" action="them-dau-sach" method="POST" >
            <div class="app__add-product">
                <div class="content__header">
                    <div class="content__name defaultCursor">
                        <a href="/QLTVQG/search-dau-sach">
                                ...
                                <div class="col-9 general-info">
                                    <div class="container">
                                        <div class="row general-info__basic">
                                            <div class="row">
                                                <div class="atb col-4">
                                                    <span class="atb-name defaultCursor">Tên đầu sách<span style="color: red"> *</span></span>
                                                    <input type="text" name="ten" class="atb-input input-group form-control shadow-none form-control shadow-none" placeholder="Nhập tên đầu sách"  autofocus >
                                                </div>
                                                <div class="atb col-4">
                                                    <span class="atb-name defaultCursor">Năm xuất bản<span style="color: red"> *</span></span>
                                                    <input type="text" name="nxb" class="atb-input input-group form-control shadow-none" placeholder="Nhập năm xuất bản" >
                                                </div>
                                                <div class="atb col-4">
                                                    <span class="atb-name defaultCursor">Tác giả<span style="color: red"> *</span></span>
                                                    <input type="text" name="tacgia" class="atb-input input-group form-control shadow-none" placeholder="Nhập tác giả" >
                                                </div>
                                                <div class="atb col-6">
                                                    <span class="atb-name defaultCursor">Giá bán (vnđ)<span style="color: red"> *</span></span>
                                                    <input type="text" name="giaban" class="atb-input input-group form-control shadow-none" placeholder="Nhập giá bán" >
                                                </div>
                                                <div class="atb col-6">
                                                    <span class="atb-name defaultCursor">Số lượng<span style="color: red"> *</span></span>
                                                    <input type="text" name="soluong" class="atb-input input-group form-control shadow-none" placeholder="Nhập số lượng" >
                                                </div>
